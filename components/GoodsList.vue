<template>
	<view class="g-list">
		...
		>
			<view class="g-list__item__img"><image :src="item.img" /></view>
			<view class="g-list__item__content">
				<view class="u-line-2">{{ item.name }}</view>
				<view class="mt-1 text-smm u-content-color">
					<text>供货商：</text>
				...
				<view class="mt-2 text-bold u-warning">{{ getPrice(item.retailPrice) }}</view>
			</view>
		</view>
	</view>
</template>
